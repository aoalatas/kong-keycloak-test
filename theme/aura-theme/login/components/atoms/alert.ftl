<#macro kw color="">
  ...
  <div class="${colorClass} p-4 rounded-lg text-sm flex items-center gap-2 " role="alert">
    <#if color="error">
        <img  src="${url.resourcesPath}/dist/assets/error_icon.svg" alt="Error" class="text-red-600">
    </#if>
    <#nested>
  </div>
</#macro>
