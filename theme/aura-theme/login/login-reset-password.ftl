...
>
  ...
  <div class="flex items-center">
    <@link.kw  href=url.loginUrl >
        <img  src="${url.resourcesPath}/dist/assets/arrow_back.svg" title=${kcSanitize(msg("backToLogin"))?no_esc}  >
    </@link.kw>
        <span class="pl-4" >${msg("emailForgotTitle")}</span>
  ...
  <#elseif section="resetPasswordInfo">
